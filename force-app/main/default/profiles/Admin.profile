...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <layoutAssignments>
        <layout>Case-Constituent Concern PageLayout</layout>
    ...
    <layoutAssignments>
        <layout>Case-Goldenrod PageLayout</layout>
        <recordType>Case.GR</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Case-Issue Memo - GOAR Scheduling PageLayout</layout>
    ...
    <layoutAssignments>
        <layout>Case-Issue Memo-GOAR PageLayout</layout>
        <recordType>Case.GO</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Case-Issue Memo-GOAR-Legal PageLayout</layout>
        <recordType>Case.GL</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Case-Issue Memo-General PageLayout</layout>
        <recordType>Case.Issue_Memorandum_General</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Case-Issue Memo-LR PageLayout</layout>
        <recordType>Case.Issue_Memorandum_Legislative_Reports</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Case-Issue Memo-NCB PageLayout</layout>
        <recordType>Case.Issue_Memorandum_NCB</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Case-Issue Memo-Others PageLayout</layout>
        <recordType>Case.Issue_Memorandum_Others</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Case-Issue Memo-PAL PageLayout</layout>
        <recordType>Case.Issue_Memorandum_PAL</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Case-Issue Memo-Rule Making PageLayout</layout>
        <recordType>Case.Issue_Memorandum_Rulemaking</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Case-Request Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Case-Request Layout</layout>
    ...
    <objectPermissions>
        ...
        <allowRead>true</allowRead>
        <modifyAllRecords>true</modifyAllRecords>
        <object>CalSTA_Reassign_Comments__c</object>
        <viewAllRecords>true</viewAllRecords>
    </objectPermissions>
    <objectPermissions>
        <allowCreate>true</allowCreate>
